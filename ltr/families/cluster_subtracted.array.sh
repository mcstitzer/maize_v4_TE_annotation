...
mkdir -p subtracted
$USEARCH --usearch_global ../mask_subtract/subtract${i}/ltrdigest/${GENOMENAME}.subtract${i}.ltrdigest_5ltr.fas -db $LTRFILE -id 0.8 -blast6out subtracted/${GENOMENAME}.ltrdigest.subtract${i}.ORIG5pLTR.id80.cov80.out -strand both -query_cov 0.8 -target_cov 0.8 -top_hits_only --threads $CPU
